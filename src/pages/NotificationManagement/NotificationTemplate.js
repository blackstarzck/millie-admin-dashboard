...
const initialTemplates = [
  ...
  },
  {
    ...
    id: "tpl004",
    name: "다른 기기 접속",
    title: "다른 기기에서 로그인이 감지되었습니다.",
    content:
      "[이름]님, 다른 기기에서의 로그인이 감지되었습니다. 본인이 아닐 경우 비밀번호를 변경해주세요.",
  ...
  },
  {
    ...
    id: "tpl006",
    name: "쿠폰 만료 D-DAY",
    title: "쿠폰이 7일 후 만료됩니다.",
    content:
      "[이름]님, 보유하신 쿠폰이 7일 후 만료될 예정입니다. 잊지 말고 사용하세요!",
    lastModified: "2024-07-29",
    channels: ["알림", "PUSH"],
  },
  {
    ...
    id: "tpl007",
    name: "구독 만료 D-DAY",
    title: "구독이 7일 후 만료됩니다.",
    content:
      "[이름]님, 구독 기간이 7일 남았습니다. 구독을 연장하고 밀리의 서재를 계속 이용해보세요.",
    lastModified: "2024-07-29",
    channels: ["알림", "PUSH"],
  },
  {
    ...
    id: "tpl008",
    name: "커뮤니티 조회수 달성",
    title: "내 게시글의 조회수가 [조회수]회를 돌파했습니다!",
    content:
      '[이름]님의 게시글이 많은 관심을 받고 있습니다! "커뮤니티에서 확인해보세요.',
    lastModified: "2024-07-29",
    channels: ["알림", "PUSH"],
  },
  {
    ...
    content:
      "[이름]님, 문의하신 내용에 대한 답변이 등록되었습니다. 지금 바로 확인해보세요.",
    lastModified: "2024-07-29",
    channels: ["알림"],
  },
  {
    ...
    content:
      "[상대방이름]님과 이제 친구입니다. 지금 바로 [상대방이름]님의 서재를 구경해보세요!",
    lastModified: "2024-07-29",
    channels: ["PUSH"],
  },
  {
    ...
    title: "구독이 해지되었습니다.",
    content:
      "[이름]님의 구독이 정상적으로 해지되었습니다. 다음에 더 좋은 모습으로 만나요.",
    lastModified: "2024-07-29",
    channels: ["알림톡"],
  },
  {
    ...
    content:
      "[이름]님의 신고가 정상적으로 접수되었습니다. 검토 후 빠르게 처리하겠습니다.",
    lastModified: "2024-07-29",
    channels: ["알림"],
  },
  {
    ...
    title: "신고가 접수되었습니다.",
    content:
      "[이름]님, 회원님의 활동에 대해 신고가 접수되었습니다. 자세한 내용은 고객센터로 문의해주세요.",
    lastModified: "2024-07-29",
    channels: ["알림"],
  },
  {
    ...
    id: "tpl014",
    name: "신간 도서 추가",
    title: "새로운 책이 밀리의 서재에 도착했어요!",
    content:
      "기다리시던 신간 [도서명]이 밀리의 서재에 추가되었습니다. 지금 바로 만나보세요!",
    lastModified: "2024-07-29",
    channels: ["알림", "PUSH"],
  },
  {
    ...
    content:
      "구독하신 시리즈 [시리즈명]의 신규 에피소드가 업데이트되었습니다. 지금 바로 감상해보세요!",
    lastModified: "2024-07-29",
    channels: ["알림", "PUSH"],
  },
  {
        ...
        <Form form={form} layout="vertical" name="notification_template_form">
          ...
          >
            <Input
              showCount
              maxLength={100}
              placeholder="예: [이름]님, 새로운 이벤트가 도착했어요!"
            />
          </Form.Item>
          <Form.Item
            name="content"
          ...
          >
            <TextArea
              ...
              maxLength={1000}
              rows={8}
              placeholder="예: [이름]님, 즐거운 독서 경험을 위해 밀리의 서재가 특별한 이벤트를 준비했어요! 지금 확인해보세요."
            />
          </Form.Item>
